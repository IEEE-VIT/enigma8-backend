...
const gameMechanics = ["Enigma 8 is neither sponsored nor associated with Apple.", "Enigma 8 is an online cryptic hunt where players solve exciting riddles and puzzles.", "There are eight rooms in total and each room has three questions.", "On solving a question, the player will receive a key", "A particular amount of keys are required to unlock a room.", "Solve every question to be the first one to solve Enigma."];
const scoringSystem = ["Upon solving a question, a player shall receive a particular amount of points relative to the other players - the earlier you solve a question, the higher your score will be. These points determine your position on the leaderboard.", "Upon using a hint, X points will be deducted from the score earned on solving that particular question."];
