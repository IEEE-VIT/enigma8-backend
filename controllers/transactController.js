  ...
  try {
    ...
    switch (powerUp.beAlias) {
      ...
      case "new_close_answer":
        ...
        let decryptedDatanewHieroglyphsCloseAnswer = decipher7.update(
          currentQuestion.newHieroglyphsCloseAnswer,
          "hex",
          "utf-8"
        );
        decryptedDatanewHieroglyphsCloseAnswer += decipher7.final("utf8");
        data = decryptedDatanewHieroglyphsCloseAnswer;
        break;
      case "free_hint":
